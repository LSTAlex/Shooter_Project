...
void AWeapon::ThrowWeapon()
{
	...
	//Направление в котором бросается оружие
	//Diretcion in which we throw the Weapon
...
{
	checkf(Ammo + Amount <= MagazineCapacity,TEXT("Reload"));
	Ammo += Amount;
}
...
void AWeapon::OnConstruction(const FTransform& Transform)
{
	...
	FString WeaponTablePath{ TEXT("DataTable'/Game/_Game/DataTable/WeaponDataTable.WeaponDataTable'") };
	...
	if (WeaponTableObject)
	{
		...
		if (WeaponDataRow)
		{
			...
			MagazineCapacity = WeaponDataRow->MagazineCapasity;
			SetPickuoSound(WeaponDataRow->PickupSound);
			...
			GetReloadMontageSection(WeaponDataRow->ReloadMontageSection);
